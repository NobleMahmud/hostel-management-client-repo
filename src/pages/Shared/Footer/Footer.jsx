        ...
        <div className="container px-6 pt-6">
            ...
            <form action="">
              <div
                ...
                <div className="relative md:mb-6" data-te-input-wrapper-init>
                  <input
                    type="text"
                    className="peer block border min-h-[auto] w-full rounded bg-transparent px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          ...
          <div className="mb-6 gap-4 flex">
            <div className="flex items-center justify-center">
              ...
              <p className='font-semibold text-md'>HungryHall</p>
            </div>
